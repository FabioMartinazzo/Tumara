...
var Crud = {
	...
	makeCreate : function() {
		...
		this.app.post('/api/' + this.model + '/create/', function (req, res) { 
	...
	makeList: function() {
		...
		this.app.post('/api/' + this.model + '/list', function (req, res){
	...
	makeUpdate : function() {
		...
		this.app.post('/api/' + this.model + '/update/:id', function (req, res){
	...
	makeListOne : function() {
		...
		this.app.post('/api/' + this.model + '/:id', function (req, res){
	...
	makeDelete : function() {
		...
		this.app.post('/api/' + this.model + '/delete/:id', function (req, res){
